...
const slides = [
  {
    ...
    titleLines: ['적극적인 제품 향상과 유지보수로', '최고의 서비스를 제공합니다'],
    titleLinesMobile: ['적극적인 제품 향상과', '유지보수로', '최고의 서비스를', '제공합니다'],
  ...
  },
  {
    ...
    titleLines: ['최고의 품질, 최적의 관리로', '고객의 지속가능한 기술개발을 돕습니다'],
    titleLinesMobile: ['최고의 품질,', '최적의 관리로', '고객의 지속가능한', '기술개발을 돕습니다'],
  ...
  },
  {
    ...
    titleLines: ['고객이 신뢰하는 제품', '최고의 콘트롤러 주문제작 기업'],
    titleLinesMobile: ['고객이 신뢰하는 제품', '최고의 콘트롤러', '주문제작 기업'],
